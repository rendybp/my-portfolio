...
const Contact = () => {
    ...
    return (
        ...
        id='contact' className='w-full px-6 lg:px-8 py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
            <div className='mx-auto max-w-7xl'>
                <motion.h4 
                initial={{y: -20, opacity: 0}}
                whileInView={{y: 0, opacity: 1}}
                transition={{delay: 0.3, duration: 0.5}}
                className='text-center mb-1 text-lg font-ovo'>Connect with me</motion.h4>
                <motion.h2 
                initial={{y: -20, opacity: 0}}
                whileInView={{y: 0, opacity: 1}}
                ...
                onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                    <div className='grid gap-6 mt-10 mb-8 grid-cols-[repeat(auto-fit,minmax(220px,1fr))]'>
                        <motion.input 
